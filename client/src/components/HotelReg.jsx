    ...
    <div className="fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70">
        <form className="flex bg-white rounded-xl max-w-4xl max-md:mx-2">
            ...
            <div className="relative flex flex-col items-center md:w-1/2 p-8 md:p-10">
                <img src={assets.closeIcon} alt="" className="absolute top-4 right-4 h-4 cursor-pointer"/>
                ...
                <div className="w-full mt-4 max-w-60 mr-auto">
                    ...
                    <select id="city" className="border border-gray-200 rounded w-full px-2.5 mt-1 outline-indigo-500 font-light" required>
                ...
                <button className="bg-indigo-500 hover:bg-indigo-600 transition-all text-white mr-auto px-6 rounded cursor-pointer mt-6">
                    Register
                </button>
            </div>
        </form>
