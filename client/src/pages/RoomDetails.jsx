...
const RoomDetails = () => {
  ...
  return (
    room && (
      <div className="py-32 md:py-35 px-4 md:px-16 lg:px25 xl:px-32">
        {/* Room Details */}
        ...
        <div className="flex flex-col md:flex-row md:justify-between mt-10">
            <div className="flex flex-col">
                <h1 className="text-3xl md:text-4xl font-playfair">Experince Luxary like never before</h1>
        ...
        <form className="flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl"> 
            ...
            <div className="flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500">
                <div className="flex flex-col">
                    ...
                    <input type="date" name="" id="checkInDate" placeholder="Check-In" className="w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none" required/>
                </div>
            </div>
        ...
        <div className="max-w-3xl border-y border-gray-300 my-16 py-10 text-gray-500">
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatum, quam. Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima, pariatur!</p>
        </div>
        {/* posted by */}
